...
var vueDragula = createCommonjsModule(function (module, exports) {
  /*!
   * vue-dragula v1.3.1
   * (c) 2017 Yichang Liu
  ...
  (function (global, factory) {
    ...
    var babelHelpers = {};
    babelHelpers["typeof"] = typeof Symbol === "function" && _typeof_1(Symbol.iterator) === "symbol" ? function (obj) {
      return _typeof_1(obj);
    } : function (obj) {
      return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : _typeof_1(obj);
    };
    ...
    var index = createCommonjsModule(function (module) {
      var NativeCustomEvent = commonjsGlobal$1.CustomEvent;
    ...
    var eventmap = createCommonjsModule(function (module) {
      ...
      for (eventname in commonjsGlobal$1) {
    ...
    var crossvent = createCommonjsModule(function (module) {
      ...
      var doc = commonjsGlobal$1.document;
      var addEvent = addEventEasy;
      var removeEvent = removeEventEasy;
      var hardCache = [];

      if (!commonjsGlobal$1.addEventListener) {
      ...
      function wrapperFactory(el, type, fn) {
        return function wrapper(originalEvent) {
          var e = originalEvent || commonjsGlobal$1.event;
    ...
    var dragula = createCommonjsModule(function (module) {
      ...
      function touchy(el, op, type, fn) {
        ...
        if (commonjsGlobal$1.navigator.pointerEnabled) {
          crossvent[op](el, pointers[type], fn);
        } else if (commonjsGlobal$1.navigator.msPointerEnabled) {
      ...
      function getScroll(scrollProp, offsetProp) {
        if (typeof commonjsGlobal$1[offsetProp] !== 'undefined') {
          return commonjsGlobal$1[offsetProp];
        }
...
var script$a = {
  ...
  created: function created() {
    ...
    Vue.vueDragula.eventBus.$on('dragend', function (e) {
      if (e[0] !== _this.dragulaBagName || !e[1] && e[1].parentElement) {
        return;
      }

      _this.$refs.mediaLibraryRenderless.setOrder(Array.from(e[1].parentElement.children || []).map(function (element) {
        return element.getAttribute('data-media-library-uuid');
      }), false);
    });
    Vue.vueDragula.options(this.dragulaBagName, {
      moves: function moves(_el, _container, handle) {
        if (!handle) {
          return false;
        }
...
return _c('div',{},[_c('icons'),_vm._v(" "),_c('div',{class:("media-library media-library-multiple " + (state.media.length == 0 ? 'media-library-empty' : 'media-library-filled') + " " + (_vm.sortable && 'media-library-sortable'))},[_c('list-errors',{attrs:{"invalid-media":state.invalidMedia,"top-level-errors":_vm.validationErrors[_vm.name]},on:{"cleared":function($event){return clearInvalidMedia()}}}),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(state.media && state.media.length),expression:"state.media && state.media.length"},{name:"dragula",rawName:"v-dragula",value:(_vm.sortable ? state.media : undefined),expression:"sortable ? state.media : undefined"}],staticClass:"media-library-items",attrs:{"bag":_vm.sortable ? _vm.dragulaBagName : undefined}},_vm._l((state.media),function(object){return _c('div',{key:object.attributes.uuid,staticClass:"media-library-item media-library-item-row",attrs:{"data-media-library-uuid":object.attributes.uuid}},[(_vm.sortable)?_c('div',{staticClass:"dragula-handle media-library-row-drag"},[(state.media.length)?_c('icon',{attrs:{"icon":"drag"}}):_vm._e()],1):_vm._e(),_vm._v(" "),_c('thumb',{attrs:{"uploadInfo":object.upload,"validation-rules":_vm.validationRules,"img-props":getImgProps(object)},on:{"replaced":function($event){return replaceMedia(object, $event)}}}),_vm._v(" "),(getErrors(object).length)?_c('item-errors',{attrs:{"object-errors":getErrors(object)},on:{"back":function($event){return clearObjectErrors(object)}}}):[_vm._t("properties",[_c('div',{staticClass:"media-library-properties media-library-properties-fixed"},[(object.attributes.extension)?_c('div',{staticClass:"media-library-property"},[_vm._v("\n                                    "+_vm._s(object.attributes.extension.toUpperCase())+"\n                                ")]):_vm._e(),_vm._v(" "),(object.attributes.size)?_c('div',{staticClass:"media-library-property"},[_vm._v("\n                                    "+_vm._s((object.attributes.size / 1024).toFixed(2))+" KB\n                                ")]):_vm._e(),_vm._v(" "),(object.attributes.original_url)?_c('div',{staticClass:"media-library-property"},[_c('a',{staticClass:"media-library-text-link",attrs:{"href":object.attributes.original_url,"download":"","target":"_blank"}},[_vm._v("\n                                        "+_vm._s(_vm.window.mediaLibraryTranslations.download)+"\n                                    ")])]):_vm._e()])],{"object":object}),_vm._v(" "),_vm._t("fields",[_c('div',{staticClass:"media-library-properties"},[_c('div',{staticClass:"media-library-field"},[_c('label',{staticClass:"media-library-label"},[_vm._v("\n                                        "+_vm._s(_vm.window.mediaLibraryTranslations.name)+"\n                                    ")]),_vm._v(" "),_c('input',_vm._g(_vm._b({staticClass:"media-library-input",attrs:{"dusk":"media-library-field-name"}},'input',getNameInputProps(object),false),getNameInputListeners(object))),_vm._v(" "),_vm._l((getNameInputErrors(object)),function(error){return _c('p',{key:error,staticClass:"media-library-field-error"},[_vm._v("\n                                        "+_vm._s(error)+"\n                                    ")])})],2)])],{"object":object,"getCustomPropertyInputProps":function (propertyName) { return getCustomPropertyInputProps(object, propertyName); },"getCustomPropertyInputListeners":function (propertyName) { return getCustomPropertyInputListeners(object, propertyName); },"getCustomPropertyInputErrors":function (propertyName) { return getCustomPropertyInputErrors(object, propertyName); },"getNameInputProps":function () { return getNameInputProps(object); },"getNameInputListeners":function () { return getNameInputListeners(object); },"getNameInputErrors":function () { return getNameInputErrors(object); }})],_vm._v(" "),_c('div',{staticClass:"media-library-row-remove",attrs:{"dusk":"remove"},on:{"click":function($event){$event.stopPropagation();return removeMedia(object)}}},[_c('icon',{attrs:{"icon":"remove"}})],1)],2)}),0),_vm._v(" "),_c('hidden-fields',{attrs:{"name":_vm.name,"media-state":state.media}}),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.maxItems || state.media.length < _vm.maxItems),expression:"!maxItems || state.media.length < maxItems"}],staticClass:"media-library-uploader"},[_c('uploader',_vm._g(_vm._b({attrs:{"add":"","multiple":"","file-type-help-text":_vm.fileTypeHelpText}},'uploader',Object.assign({}, getDropZoneProps(), getFileInputProps()),false),Object.assign({}, getDropZoneListeners(), getFileInputListeners())))],1)],1)],1)}}])})};
...
export { __vue_component__$b as MediaLibraryCollection };
