 ...
 */function isObject$1(val){return val!==null&&_typeof_1(val)==='object';}/**
 ...
 * @returns {Function}
 */var spread=function spread(callback){return function wrap(arr){return callback.apply(null,arr);};};var isAxiosError=function isAxiosError(payload){return _typeof_1(payload)==='object'&&payload.isAxiosError===true;};/**
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('svg', {
    ...
    staticClass: "media-library-icon-fill",
    attrs: {
...
var __vue_render__$1 = function __vue_render__$1() {
  ...
  return _c('svg', {
    staticClass: "media-library-icon"
  }, [_c('use', {
    attrs: {
      "xlink:href": '#icon-' + _vm.icon
    }
  })]);
};
    ...
    getDropZoneListeners: function getDropZoneListeners() {
      ...
      return {
        dropped: function dropped(event) {
          _this6.addFiles(event.dataTransfer.files);
        }
      };
    },
...
var __vue_render__$2 = function __vue_render__$2() {
  ...
  }, [_vm._l(_vm.mediaState, function (object, i) {
    return [_vm._l(_vm.getObjPaths(object.attributes), function (parameterName) {
      return [_c('input', {
        key: i + parameterName,
        attrs: {
          "name": _vm.name + "[" + object.attributes.uuid + "]" + parameterName,
          "type": "hidden"
        },
        domProps: {
          "value": _vm.sanitizeForInput(_vm.get(object.attributes, parameterName))
        }
      })];
    })];
  })], 2);
...
var __vue_render__$3 = function __vue_render__$3() {
  ...
  }, 'div', _vm.$attrs, false), [_vm._t("default", null, null, _vm.$data)], 2);
};
...
var __vue_render__$4 = function __vue_render__$4() {
  ...
  return _vm.objectErrors.length > 0 ? _c('div', {
    staticClass: "media-library-properties"
  }, [_c('span', {
    staticClass: "media-library-text-error"
  }, _vm._l(_vm.objectErrors, function (error) {
    return _c('span', {
      key: error
    }, [_vm._v(_vm._s(error))]);
  }), 0), _vm._v(" "), _c('a', {
    staticClass: "media-library-text-link media-library-text-error media-library-help-clear",
    on: {
      "click": function click($event) {
        $event.stopPropagation();
...
var __vue_render__$5 = function __vue_render__$5() {
  ...
  return _c('li', {
    staticClass: "media-library-listerror"
  }, [_c('div', {
    staticClass: "media-library-listerror-icon"
  }, [_c('span', {
    staticClass: "media-library-button media-library-button-error"
  }, [_c('icon', {
    attrs: {
      "icon": "error"
    }
  })], 1)]), _vm._v(" "), _c('div', {
    staticClass: "media-library-listerror-content"
  }, [_c('div', {
    staticClass: "media-library-listerror-title"
  }, [_c('span', [_vm._v(_vm._s(_vm.title))])]), _vm._v(" "), _vm.$slots["default"] ? _c('ul', {
    staticClass: "media-library-listerror-items"
...
var __vue_render__$6 = function __vue_render__$6() {
  ...
  return _vm.imageErrored ? _c('span', {
    staticClass: "media-library-thumb-extension"
  }, [_c('span', {
    staticClass: "media-library-thumb-extension-truncate"
  }, [_vm._v(_vm._s(_vm.name.split('.').pop()))])]) : _c('img', {
    staticClass: "media-library-thumb-img",
    attrs: {
      "src": _vm.client_preview
    },
    on: {
      "error": function error($event) {
        _vm.imageErrored = true;
      }
    }
  });
};
...
var __vue_render__$7 = function __vue_render__$7() {
  ...
  return _vm.invalidMedia.length || _vm.topLevelErrors.length && !_vm.hideTopLevelErrors ? _c('div', {
    staticClass: "media-library-listerrors"
  }, [_c('ul', [!_vm.hideTopLevelErrors ? _vm._l(_vm.topLevelErrors, function (error, i) {
    return _c('list-error', {
      key: "top-level-" + i,
      attrs: {
        "title": error
      }
    });
  }) : _vm._e(), _vm._v(" "), _vm._l(Object.entries(_vm.groupedInvalidMedia), function (ref, i) {
    var error = ref[0];
    ...
    }, _vm._l(invalidObjects, function (object, i) {
      return _c('li', {
        key: i,
        staticClass: "media-library-listerror-item"
      }, [_c('div', {
        staticClass: "media-library-listerror-thumb"
      }, [_c('object-preview', {
        attrs: {
        ...
        staticClass: "media-library-listerror-text"
      }, [_vm._v(_vm._s(object.attributes.name))])]);
    }), 0);
  })], 2), _vm._v(" "), _c('div', {
    staticClass: "media-library-row-remove media-library-text-error",
    on: {
      "click": function click($event) {
        $event.stopPropagation();
...
var __vue_render__$8 = function __vue_render__$8() {
  ...
  return _c('span', {
    "class": "media-library-button media-library-button-" + _vm.level
  }, [_c('icon', {
    attrs: {
      "icon": _vm.icon
    }
...
var __vue_render__$9 = function __vue_render__$9() {
  ...
  return _c('drop-zone', _vm._b({
    "class": _vm.add ? 'media-library-add' : 'media-library-replace',
    attrs: {
      "validation-accept": (_vm.validationRules || {}).accept
    },
    on: {
      "clicked": function clicked($event) {
        return _vm.$refs.fileInputRef.click();
      },
      "dropped": function dropped($event) {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(ref) {
        ...
        return _c('button', {
          "class": "media-library-dropzone\n            " + (hasDragObject && !isDropTarget ? 'media-library-dropzone-drag' : '') + "\n            " + (hasDragObject && isDropTarget ? 'media-library-dropzone-drop' : '') + "\n            " + (_vm.add ? 'media-library-dropzone-add' : 'media-library-dropzone-replace') + "\n            " + (!isValid && hasDragObject ? 'disabled' : '') + "\n        ",
          attrs: {
            "type": "button"
          }
        }, [_c('input', {
          ref: "fileInputRef",
          staticClass: "media-library-hidden",
          attrs: {
            "type": "file",
            "accept": (_vm.validationRules || {}).accept ? (_vm.validationRules || {}).accept.join(',') : undefined,
            "multiple": _vm.multiple,
            "dusk": _vm.add ? 'main-uploader' : 'uploader'
          },
          on: {
          ...
          staticClass: "media-library-placeholder"
        }, [isValid || !hasDragObject ? _c('icon-button', {
          attrs: {
            "level": "info",
            "icon": _vm.add ? 'add' : 'replace'
          }
        }) : _c('icon-button', {
          attrs: {
            "level": "warning",
        ...
        }), _vm._v(" "), _vm.uploadInfo ? _c('div', {
          "class": "media-library-progress-wrap " + (_vm.uploadInfo.hasFinishedUploading ? '' : 'media-library-progress-wrap-loading')
        }, [_c('progress', {
          staticClass: "media-library-progress",
          attrs: {
            "max": "100"
          },
          domProps: {
            "value": _vm.uploadInfo.uploadProgress
          }
        })]) : _vm._e()], 1), _vm._v(" "), _vm.add ? _c('div', {
          staticClass: "media-library-help"
        }, [isValid && hasDragObject ? [isDropTarget ? _c('span', [_vm._v(_vm._s(_vm.window.mediaLibraryTranslations.dropFile))]) : _c('span', [_vm._v(_vm._s(_vm.window.mediaLibraryTranslations.dragHere))])] : _c('span', [_vm._v(_vm._s(_vm.buildRuleHelpText({
          validationRules: _vm.validationRules,
          maxItems: _vm.maxItems,
          fileTypeHelpText: _vm.fileTypeHelpText
        })))])], 2) : _vm._e()]);
      }
    }])
  }, 'drop-zone', _vm.$attrs, false));
};
...
var __vue_render__$a = function __vue_render__$a() {
  ...
  return _c('div', {
    staticClass: "media-library-thumb",
    attrs: {
      "dusk": "thumb"
    }
  }, [!!_vm.imgProps.src && !_vm.imageErrored ? _c('img', _vm._b({
    staticClass: "media-library-thumb-img",
    on: {
      "error": function error($event) {
        _vm.imageErrored = true;
  ...
  }, 'img', _vm.imgProps, false)) : _c('span', {
    staticClass: "media-library-thumb-extension"
  }, [_c('span', {
    staticClass: "media-library-thumb-extension-truncate"
  }, [_vm._v(_vm._s(_vm.imgProps.extension))])]), _vm._v(" "), _c('uploader', _vm._b({
    attrs: {
      "validation-rules": _vm.validationRules,
      "add": false,
      "multiple": false,
      "upload-info": _vm.uploadInfo
    },
    on: {
      "dropped": function dropped($event) {
        return _vm.$emit('replaced', $event.dataTransfer.files[0]);
      },
      "changed": function changed($event) {
        return _vm.$emit('replaced', $event.target.files[0]);
      }
    }
  }, 'uploader', _vm.$attrs, false))], 1);
};
...
var script$a = {
  ...
  components: {
    ...
    HiddenFields: __vue_component__$2,
    DropZone: __vue_component__$3,
    ListErrors: __vue_component__$7,
    ItemErrors: __vue_component__$4,
    Icons: __vue_component__,
    Thumb: __vue_component__$a,
    Uploader: __vue_component__$9
  },
  data: function data() {
    return {
...
/* template */
var __vue_render__$b = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('media-library-renderless',{ref:"mediaLibraryRenderless",attrs:{"initial-value":_vm.initialValue,"validation-errors":_vm.validationErrors,"route-prefix":_vm.routePrefix,"validation-rules":_vm.validationRules,"translations":_vm.translations,"before-upload":_vm.beforeUpload,"after-upload":_vm.afterUpload,"multiple":_vm.multiple,"name":_vm.name,"max-items":_vm.computedMaxItems,"max-size-for-preview-in-bytes":_vm.maxSizeForPreviewInBytes,"vapor":_vm.vapor,"vapor-signed-storage-url":_vm.vaporSignedStorageUrl,"upload-domain":_vm.uploadDomain,"with-credentials":_vm.withCredentials,"headers":_vm.headers},on:{"changed":function($event){return _vm.$emit('change', $event)},"is-ready-to-submit-change":function($event){return _vm.$emit('is-ready-to-submit-change', $event)},"has-uploads-in-progress-change":function($event){return _vm.$emit('has-uploads-in-progress-change', $event)}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
        var state = ref.state;
        var getImgProps = ref.getImgProps;
        var getNameInputProps = ref.getNameInputProps;
        var getNameInputListeners = ref.getNameInputListeners;
        var getNameInputErrors = ref.getNameInputErrors;
        var getCustomPropertyInputProps = ref.getCustomPropertyInputProps;
        var getCustomPropertyInputListeners = ref.getCustomPropertyInputListeners;
        var getCustomPropertyInputErrors = ref.getCustomPropertyInputErrors;
        var getDropZoneProps = ref.getDropZoneProps;
        var getDropZoneListeners = ref.getDropZoneListeners;
        var getFileInputProps = ref.getFileInputProps;
        var getFileInputListeners = ref.getFileInputListeners;
        var removeMedia = ref.removeMedia;
        var replaceMedia = ref.replaceMedia;
        var getErrors = ref.getErrors;
        var clearObjectErrors = ref.clearObjectErrors;
        var clearInvalidMedia = ref.clearInvalidMedia;
return _c('div',{},[_c('icons'),_vm._v(" "),_c('div',{staticClass:"media-library",class:[
                _vm.multiple ? 'media-library-multiple' : 'media-library-single',
                state.media.length == 0 ? 'media-library-empty' : 'media-library-filled' ]},[_c('list-errors',{attrs:{"invalid-media":state.invalidMedia,"top-level-errors":_vm.validationErrors[_vm.name]},on:{"cleared":function($event){return clearInvalidMedia()}}}),_vm._v(" "),(state.media && state.media.length)?_c('div',{staticClass:"media-library-items"},_vm._l((state.media),function(object){return _c('div',{key:object.attributes.uuid,staticClass:"media-library-item"},[_c('thumb',{attrs:{"uploadInfo":object.upload,"validation-rules":_vm.validationRules,"img-props":getImgProps(object)},on:{"replaced":function($event){return replaceMedia(object, $event)}}}),_vm._v(" "),_c('div',{staticClass:"media-library-properties"},[(getErrors(object).length)?_c('item-errors',{attrs:{"object-errors":getErrors(object)},on:{"back":function($event){return clearObjectErrors(object)}}}):[_vm._t("properties",[(object.attributes.extension)?_c('div',{staticClass:"media-library-property"},[_vm._v("\n                                    "+_vm._s(object.attributes.extension.toUpperCase())+"\n                                ")]):_vm._e(),_vm._v(" "),(object.attributes.size)?_c('div',{staticClass:"media-library-property"},[_vm._v("\n                                    "+_vm._s((object.attributes.size / 1024).toFixed(2))+" KB\n                                ")]):_vm._e()],{"object":object}),_vm._v(" "),_vm._t("fields",null,{"object":object,"getCustomPropertyInputProps":function (propertyName) { return getCustomPropertyInputProps(object, propertyName); },"getCustomPropertyInputListeners":function (propertyName) { return getCustomPropertyInputListeners(object, propertyName); },"getCustomPropertyInputErrors":function (propertyName) { return getCustomPropertyInputErrors(object, propertyName); },"getNameInputProps":function () { return getNameInputProps(object); },"getNameInputListeners":function () { return getNameInputListeners(object); },"getNameInputErrors":function () { return getNameInputErrors(object); }}),_vm._v(" "),_c('div',{staticClass:"media-library-property"},[_c('button',{staticClass:"media-library-text-link",attrs:{"type":"button","dusk":"remove"},on:{"click":function($event){$event.stopPropagation();return removeMedia(object)}}},[_vm._v("\n                                    "+_vm._s(_vm.window.mediaLibraryTranslations.remove)+"\n                                ")])])]],2)],1)}),0):_vm._e(),_vm._v(" "),_c('hidden-fields',{attrs:{"name":_vm.name,"media-state":state.media}}),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.computedMaxItems || state.media.length < _vm.computedMaxItems),expression:"!computedMaxItems || state.media.length < computedMaxItems"}],staticClass:"media-library-uploader"},[_c('uploader',_vm._g(_vm._b({attrs:{"multiple":_vm.multiple,"add":"","file-type-help-text":_vm.fileTypeHelpText}},'uploader',Object.assign({}, getDropZoneProps(), getFileInputProps()),false),Object.assign({}, getDropZoneListeners(), getFileInputListeners())))],1)],1)],1)}}])})};
...
export { __vue_component__$b as MediaLibraryAttachment };
